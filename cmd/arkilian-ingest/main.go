...
func main() {
	...
	// Create HTTP handler
	ingestHandler := httpapi.NewIngestHandler(builder, metaGen, catalog, store, nil, nil, nil)
	...
	ingestServer := grpcapi.NewIngestServer(builder, metaGen, catalog, store, nil, nil)
