...
const (
	IngestService_BatchIngest_FullMethodName = "/arkilian.v1.IngestService/BatchIngest"
)
...
type IngestServiceClient interface {
	...
	BatchIngest(ctx context.Context, in *IngestRequest, opts ...grpc.CallOption) (*IngestResponse, error)
}
...
func (c *ingestServiceClient) BatchIngest(ctx context.Context, in *IngestRequest, opts ...grpc.CallOption) (*IngestResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(IngestResponse)
	err := c.cc.Invoke(ctx, IngestService_BatchIngest_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type IngestServiceServer interface {
	// BatchIngest ingests a batch of rows into a partition.
	// This is the high-throughput gRPC endpoint for data ingestion.
	BatchIngest(context.Context, *IngestRequest) (*IngestResponse, error)
...
func (UnimplementedIngestServiceServer) BatchIngest(context.Context, *IngestRequest) (*IngestResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method BatchIngest not implemented")
}
...
func _IngestService_BatchIngest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: IngestService_BatchIngest_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IngestServiceServer).BatchIngest(ctx, req.(*IngestRequest))
	}
...
var IngestService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "arkilian.v1.IngestService",
	...
	Metadata: "api/proto/arkilian.proto",
}
